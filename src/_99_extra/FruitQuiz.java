...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel(
				"<html>How do pinapples grow ? <br> A:the ground. <br> B:  from a plant. <br> C:trees.</html>");
		question3 = new JLabel(
				"<html>how do banana trees grow? <br> A: seeds <br> B: polen nating other trees  <br> C: people genetickly made them</html>");
	...
	private void incorrect() {
		System.out.println("im sorry but that is not correct.");
